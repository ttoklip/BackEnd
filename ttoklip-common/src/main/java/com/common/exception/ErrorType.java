...
public enum ErrorType {
    ...
    UNAUTHORIZED_ADMIN_DELETE_POST(FORBIDDEN, "AUTH_4034", "이 게시글은 관리자만 삭제할 수 있습니다."),
    UNAUTHORIZED_ADMIN_EDIT_POST(FORBIDDEN, "AUTH_4035", "이 게시글은 관리자만 수정할 수 있습니다."),
    ...
    // ------------------------------------------ Auth ------------------------------------------
    STREET_EMPTY(BAD_REQUEST, "Street_4001", "주소는 비어있을 수 없습니다. 주소가 비어있다는 건 회원가입 후 정보를 입력하지 않았음을 의미합니다."),
