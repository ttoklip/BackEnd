...
public class CartPostController {
    ...
    public TtoklipResponse<Message> register(final @Validated @ModelAttribute CartWebCreate request) {
    ...
    @GetMapping("/{postId}")
    public TtoklipResponse<CartResponse> getSinglePost(final @PathVariable Long postId) {
        Long currentMemberId = SecurityUtil.getCurrentMember().getId();
    ...
    @PatchMapping("/{postId}")
    public TtoklipResponse<Message> edit(final @PathVariable Long postId,
    ...
    public TtoklipResponse<Message> updateStatus(final @PathVariable Long postId,
    ...
    @ApiResponses(value = {
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "200", description = "참여자 추가 성공",
                    content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE,
                            schema = @Schema(implementation = TtoklipResponse.class),
                            examples = @ExampleObject(
                                    name = "SuccessResponse",
    ...
    public TtoklipResponse<Message> addParticipant(final @PathVariable Long cartId) {
        Long currentMemberId = SecurityUtil.getCurrentMember().getId();
    ...
    @ApiResponses(value = {
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "200", description = "참여 취소 성공",
                    content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE,
                            schema = @Schema(implementation = TtoklipResponse.class),
                            examples = @ExampleObject(
                                    name = "SuccessResponse",
    ...
    public TtoklipResponse<Message> removeParticipant(final @PathVariable Long cartId) {
        Long currentMemberId = SecurityUtil.getCurrentMember().getId();
    ...
    @ApiResponses(value = {
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "200", description = "참여자 수 확인 성공",
                    content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE,
                            schema = @Schema(implementation = TtoklipResponse.class),
                            examples = @ExampleObject(
                                    name = "SuccessResponse",
    ...
    public TtoklipResponse<Long> countParticipants(final @PathVariable Long cartId) {
    ...
    @ApiResponses(value = {
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "200", description = "참여자 확인 성공",
                    content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE,
                            schema = @Schema(implementation = TtoklipResponse.class),
                            examples = @ExampleObject(
                                    name = "SuccessResponse",
    ...
    public TtoklipResponse<CartGroupMemberResponse> checkParticipants(final @PathVariable Long cartId) {
        Long currentMemberId = SecurityUtil.getCurrentMember().getId();
        CartGroupMemberResponse cartGroupMemberResponse = cartPostFacade.checkParticipants(cartId, currentMemberId);
        return new TtoklipResponse<>(cartGroupMemberResponse);
    }
