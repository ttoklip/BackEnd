...
public class ProfileController {
    ...
    @ApiResponses(value = {
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "200", description = "개인정보 입력",
                    content = @Content(
    ...
    @PostMapping("/insert")
    public TtoklipResponse<Message> register(@ModelAttribute @Validated final ProfileWebCreate request) {
    ...
    @ApiResponses(value = {
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "200", description = "닉네임 중복 확인",
                    content = @Content(
                            mediaType = MediaType.APPLICATION_JSON_VALUE,
                            schema = @Schema(implementation = TtoklipResponse.class),
                            examples = @ExampleObject(
    ...
    public TtoklipResponse<Message> checkOauthNickname(@RequestBody final Nickname nickname) {
    ...
    public TtoklipResponse<Message> checkLocalNickname(@RequestBody final Nickname nickname) {
        Message message = profileFacade.validNickname(nickname);
        return new TtoklipResponse<>(message);
    }
}
