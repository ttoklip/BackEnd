...
public class NewsletterPostController {
    ...
    public TtoklipResponse<Message> register(final @Validated @ModelAttribute NewsletterWebCreate request) {
    ...
    @GetMapping("/{postId}")
    public TtoklipResponse<NewsletterSingleResponse> getSinglePost(final @PathVariable Long postId) {
        Long currentMemberId = SecurityUtil.getCurrentMember().getId();
