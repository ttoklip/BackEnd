...
public class NewsletterPostController {
    ...
    public SuccessResponse<Message> register(final @Validated @ModelAttribute NewsletterWebCreate request) {
        Long currentMemberId = SecurityUtil.getCurrentMember().getId();
        return new SuccessResponse<>(newsletterPostFacade.register(request, currentMemberId));
    }
    ...
    public SuccessResponse<NewsletterSingleResponse> getSinglePost(final @PathVariable Long postId) {
        Long currentMemberId = SecurityUtil.getCurrentMember().getId();
        return new SuccessResponse<>(newsletterPostFacade.getSinglePost(postId, currentMemberId));
    }
    ...
    public SuccessResponse<Message> delete(final @PathVariable Long postId) {
        Long currentMemberId = SecurityUtil.getCurrentMember().getId();
        return new SuccessResponse<>(newsletterPostFacade.delete(postId, currentMemberId));
    }
}
